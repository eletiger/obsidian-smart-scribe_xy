...
**Original project location:** gloamfox/obsidian-smart-scribe

**Special Note: **  
Two modifications have been made compared to the original version.  
1. Add support for the local models Ollama and LM Studio;
2. Fix the issue where "text optimization" does not save to disk.
