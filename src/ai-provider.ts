...
// 支持的 AI 平台类型
export type AIPlatform = "claude" | "openai" | "deepseek" | "qwen" | "zhipu" | "spark" | "ollama" | "lmstudio";
...
// 从 Ollama 本地实例获取已安装的模型列表
export async function fetchOllamaModels(baseUrl: string): Promise<string[]> {
	try {
		// 从 OpenAI 兼容路径 (/v1) 推导出 Ollama 根路径
